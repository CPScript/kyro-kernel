...
void paging_init(void) {
    ...
    // For now, let's use a very simple doohicky (identity mapping)
    // This avoids complex page fault handling during boot
    
    // Initialize frame bitmap for 16MB of RAM (reduced from 32MB)
    ...
    // Identity map first 8MB (increased from 4MB to be safer)
